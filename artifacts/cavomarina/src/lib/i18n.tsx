...
const T = {
  en: {
    ...
    about_desc: "Cavomarina Beach Hotel is more than just a hotel. It is a place where mornings begin with the sound of the sea, where the horizon seems endless, and where the beauty of the Greek coastline becomes part of everyday life.",
    about_gallery: "View Gallery",
    // ── Rooms
    rooms_label: "Accommodation", rooms_title: "Our Rooms", rooms_view: "View Room →",
    room1_title: "Comfort Mountain / Garden View", room1_desc: "Mountain & garden views, AC, flat-screen TV", room1_size: "20 m²",
    room2_title: "Superior Swim-Up Room", room2_desc: "Modern design, satellite TV, pool view", room2_size: "25 m²",
    room3_title: "Comfort Sea View", room3_desc: "1st & 2nd floor, sea & surroundings views", room3_size: "22 m²",
    room4_title: "Penthouse Room", room4_desc: "Exclusive rooftop experience, panoramic sea views", room4_size: "Exclusive",
    room5_title: "Superior Spa Room", room5_desc: "In-room jacuzzi, spa amenities, luxury finishes", room5_size: "30 m²",
    // ── Amenities
    ...
    room_opt1: "Comfort Mountain / Garden View", room_opt2: "Superior Swim-Up Room",
    room_opt3: "Comfort Sea View", room_opt4: "Penthouse Room", room_opt5: "Superior Spa Room",
    // ── Footer
    ...
    dc_nav_weather: "Weather & Climate", dc_nav_practical: "Practical Info",
    ...
    dc_weather_title: "Weather & Climate", dc_weather_sub: "Plan your perfect Corfu getaway",
    dc_weather_best: "Best time to visit", dc_weather_open: "Hotel open season",
    dc_weather_sea: "Sea °C", dc_weather_high: "High", dc_weather_low: "Low",
    dc_nav_events: "Local Events",
    dc_events_title: "Local Events & Festivals", dc_events_sub: "Seasonal celebrations and cultural highlights around Kavos & Corfu",
  ...
  de: {
    ...
    about_desc: "Das Cavomarina Beach Hotel ist mehr als nur ein Hotel. Es ist ein Ort, an dem die Morgen mit dem Klang des Meeres beginnen, der Horizont endlos erscheint und die Schönheit der griechischen Küste Teil des Alltags wird.",
    about_gallery: "Galerie Ansehen",
    rooms_label: "Unterkunft", rooms_title: "Unsere Zimmer", rooms_view: "Zimmer Ansehen →",
    room1_title: "Comfort Berg- / Gartenblick", room1_desc: "Berg- & Gartenblick, Klimaanlage, Flachbildfernseher", room1_size: "20 m²",
    room2_title: "Superior Swim-Up Zimmer", room2_desc: "Modernes Design, Satelliten-TV, Poolblick", room2_size: "25 m²",
    room3_title: "Comfort Meerblick", room3_desc: "1. & 2. Etage, Blick auf das Meer und die Umgebung", room3_size: "22 m²",
    room4_title: "Penthouse Room", room4_desc: "Exklusives Dachterrassen-Erlebnis, Panoramablick auf das Meer", room4_size: "Exklusiv",
    room5_title: "Superior Spa Zimmer", room5_desc: "Zimmer-Jacuzzi, Spa-Ausstattung, luxuriöses Ambiente", room5_size: "30 m²",
    ...
    room_opt1: "Comfort Berg- / Gartenblick", room_opt2: "Superior Swim-Up Zimmer",
    room_opt3: "Comfort Meerblick", room_opt4: "Penthouse Room", room_opt5: "Superior Spa Zimmer",
    ...
    dc_nav_weather: "Wetter & Klima", dc_nav_practical: "Praktische Infos",
    ...
    dc_weather_title: "Wetter & Klima", dc_weather_sub: "Planen Sie Ihren perfekten Korfu-Urlaub",
    dc_weather_best: "Beste Reisezeit", dc_weather_open: "Hotelsaison",
    dc_weather_sea: "Meer °C", dc_weather_high: "Max", dc_weather_low: "Min",
    dc_nav_events: "Veranstaltungen",
    dc_events_title: "Lokale Events & Feste", dc_events_sub: "Saisonale Feiern und kulturelle Highlights rund um Kavos & Korfu",
  ...
  el: {
    ...
    about_desc: "Το Cavomarina Beach Hotel είναι κάτι περισσότερο από ένα ξενοδοχείο. Είναι ένας τόπος όπου τα πρωινά ξεκινούν με τον ήχο της θάλασσας, ο ορίζοντας φαίνεται ατελείωτος και η ομορφιά της ελληνικής ακτής γίνεται κομμάτι της καθημερινής ζωής.",
    about_gallery: "Δείτε τη Γκαλερί",
    rooms_label: "Διαμονή", rooms_title: "Τα Δωμάτιά μας", rooms_view: "Δείτε το Δωμάτιο →",
    room1_title: "Comfort Θέα Βουνό / Κήπο", room1_desc: "Θέα βουνό & κήπο, κλιματισμός, οθόνη", room1_size: "20 m²",
    room2_title: "Superior Swim-Up Δωμάτιο", room2_desc: "Μοντέρνο design, δορυφορική TV, θέα στην πισίνα", room2_size: "25 m²",
    room3_title: "Comfort Θέα Θάλασσα", room3_desc: "1ος & 2ος όροφος, θέα στη θάλασσα και το τοπίο", room3_size: "22 m²",
    room4_title: "Penthouse Room", room4_desc: "Αποκλειστική εμπειρία στην οροφή, πανοραμική θέα θάλασσας", room4_size: "Αποκλειστικό",
    room5_title: "Superior Spa Δωμάτιο", room5_desc: "Jacuzzi δωματίου, παροχές spa, πολυτελείς φινέτσες", room5_size: "30 m²",
    ...
    room_opt1: "Comfort Θέα Βουνό / Κήπο", room_opt2: "Superior Swim-Up Δωμάτιο",
    room_opt3: "Comfort Θέα Θάλασσα", room_opt4: "Penthouse Room", room_opt5: "Superior Spa Δωμάτιο",
    ...
    dc_nav_weather: "Καιρός & Κλίμα", dc_nav_practical: "Πρακτικές Πληροφορίες",
    ...
    dc_weather_title: "Καιρός & Κλίμα", dc_weather_sub: "Σχεδιάστε τις διακοπές σας στην Κέρκυρα",
    dc_weather_best: "Καλύτερη περίοδος", dc_weather_open: "Σεζόν ξενοδοχείου",
    dc_weather_sea: "Θάλ. °C", dc_weather_high: "Μέγ", dc_weather_low: "Ελάχ",
    dc_nav_events: "Εκδηλώσεις",
    dc_events_title: "Τοπικές Εκδηλώσεις & Φεστιβάλ", dc_events_sub: "Εποχιακές γιορτές και πολιτιστικές εμπειρίες στον Καβό & την Κέρκυρα",
